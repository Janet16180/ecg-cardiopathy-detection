...
- [CPC improvement investigation](cpc-improvement-investigation.md), [ranked findings](cpc-improvement-research-2026-09-25.md), and [proposed local-readout protocol](cpc-local-readout-v1.md)
