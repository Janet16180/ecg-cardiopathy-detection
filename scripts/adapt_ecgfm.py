...
def main():
    ...
    config = {
        ...
        "extractor_source_sha256": sha256(Path(__file__).with_name("extract_pretrained.py")),
        "official_source_commit": git_head(Path(__file__).resolve().parents[1] / "third_party" / "fairseq-signals"),
    }
