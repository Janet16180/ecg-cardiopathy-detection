"""Matched CPC continuation using the verified local sampled-cohort cache."""
...
OUTPUT = ROOT / "outputs/experiment018_cpc_data_scaling_v2"
SEED = 18042
BATCH = 128
LR = 1e-4
PROFILE_BATCHES = 24
...
def input_identity() -> dict[str, str | int | float]:
    ...
    paths = {
        ...
        "cache_builder_source_at_launch": OUTPUT / "cache_builder_source_at_launch.py",
        "cache_builder_source_shard_parallel": OUTPUT / "cache_builder_source_shard_parallel.py",
        "cache_builder_source_shard_prefetch": OUTPUT / "cache_builder_source_shard_prefetch.py",
        "cache_builder_source_flush4096": OUTPUT / "cache_builder_source_flush4096.py",
...
def profile(old: Dataset, new: Dataset, identity: dict[str, str | int | float],
    ...
    receipt = {"identity": identity, "profile": results,
               ...
               "method": "cold real-data loader+GPU update mean, 1.25 margin, 180s report reserve"}
