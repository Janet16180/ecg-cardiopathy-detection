...
from scripts.prepare_public_ecg import ROOT, SOURCE, load_view, signal_sha256
...
def materialize(prepared_dir: Path, output_dir: Path, *, shard_size: int = 128,
    ...
    try:
        ...
        result = {
            ...
            "canonicalization_source_sha256": sha256(ROOT / "scripts/prepare_public_ecg.py") if (ROOT / "scripts/prepare_public_ecg.py").exists() else None,
