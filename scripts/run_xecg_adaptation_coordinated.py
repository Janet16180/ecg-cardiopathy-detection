...
from scripts.run_xecg_coordinated import identity
...
def main():
    ...
    for value, expected in ((previous, b"scripts.run_xecg_coordinated"),
                            (preparation, b"scripts.prepare_xecg_ssl"),
                            (mimic, b"scripts.run_mimic_scale")):
    ...
    try:
        ...
        for stage in ("profile", "all"):
            command = [sys.executable, "-u", "-m", "scripts.run_xecg_adaptation",
